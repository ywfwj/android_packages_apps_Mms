...
public class SmileyParser {
    ...
    public static final int[] DEFAULT_SMILEY_RES_IDS = {
		...
		Smileys.getSmileyResource(Smileys.LIPS_ARE_SEALED),      //  22
		Smileys.getSmileyResource(Smileys.LIPS_ARE_SEALED),      //  23
        Smileys.getSmileyResource(Smileys.EMBARRASSED),          //  24
    };
